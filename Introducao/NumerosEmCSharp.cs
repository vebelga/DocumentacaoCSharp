...
{
    public static class NumerosEmCSharp
    {
        ...
        public static void WorkWithDecimal()
        {
            ...
            //O sufixo M nos números é o modo de indicar que uma constante deve usar o tipo decimal
